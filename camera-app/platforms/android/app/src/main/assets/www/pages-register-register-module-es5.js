  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-register-register-module"], {
    ...
    function srcAppPagesRegisterRegisterPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var RegisterPage = /*#__PURE__*/function () {
        ...
        function RegisterPage(menu, toastController, loadingController, myservice, router) {
        ...
        _createClass(RegisterPage, [{
          ...
          value: function Register() {
            ...
            if (this.email.length < 11) {
              ...
              firebase__WEBPACK_IMPORTED_MODULE_3__["default"].auth().createUserWithEmailAndPassword(userDetails.email, userDetails.password).then(function (message) {
                console.log(message);

                try {
                  var save = _this.myservice.saveUserDetails(userDetails);
